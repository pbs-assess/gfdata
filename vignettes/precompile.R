...
knitr::knit("vignettes/gfdata-vignette.Rmd.orig", output = "vignettes/gfdata-vignette.Rmd")
knitr::knit("vignettes/gfdata-vignette-get-all.Rmd.orig", output = "vignettes/gfdata-vignette-get-all.Rmd")
