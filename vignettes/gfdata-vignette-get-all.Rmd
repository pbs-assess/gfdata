...
However, when these filtering options are applied to certain surveys, a small proportion of the data returned by the original function may be missed (e.g., IPHC: `ssid = 14`) and no data is returned for surveys for which these codes have not been generated (e.g., the jig survey: `ssid = c(82:87)`).
