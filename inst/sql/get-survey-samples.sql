SELECT TRIP_START_DATE,
 ...
 CASE WHEN SURVEY_SERIES_ALT_DESC IS NULL THEN SURVEY_SERIES_TYPE_ALT_DESC
  ...
  CASE WHEN DNA.COLLECTED_ATTRIBUTE_CODE IN (4)
     THEN DNA.STORAGE_CONTAINER_TYPE_CODE
     ELSE 'NA' END AS DNA_SAMPLE_TYPE,
  CASE WHEN DNA.COLLECTED_ATTRIBUTE_CODE IN (4)
     THEN DNA.STORAGE_CONTAINER_SUB_ID
     ELSE 'NA' END AS DNA_CONTAINER_ID,
  TRIP_SUB_TYPE_CODE,
  SM.SAMPLE_TYPE_CODE,
