   ...
   WHERE (FE.FE_PARENT_EVENT_ID IS NULL OR (FE.FE_PARENT_EVENT_ID IS NOT NULL AND TA.ACTIVITY_CODE IN (53) AND FE.FE_MINOR_LEVEL_ID IS NULL))
   ...
   GROUP BY C.SPECIES_CODE, FE.GEAR_CODE, A.ACTIVITY_DESC, TA.ACTIVITY_CODE,
      ...
      FE.FE_PARENT_EVENT_ID, FE.FE_MAJOR_LEVEL_ID, FE.FE_SUB_LEVEL_ID, T.TRIP_START_DATE,
      S.ORIGINAL_IND
