SELECT
  SS.SURVEY_SERIES_ID AS SURVEY_SERIES_ID,
  G.SURVEY_SERIES_ID AS SURVEY_SERIES_ID_TRUE,
  A.ACTIVITY_DESC,
  TA.ACTIVITY_CODE,
  SM.FISHING_EVENT_ID,
  ...
  LEFT JOIN SURVEY_SERIES SS ON SS.SURVEY_SERIES_ID = G.SURVEY_SERIES_ID
