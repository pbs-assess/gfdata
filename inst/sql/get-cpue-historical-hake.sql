...
WHERE --MC.SPECIES_CODE = '225' AND
	--Use data from major areas 3CD, 5ABCDE and minor area 20 in major area 1 (Juan de Fuca Strait entrance)
	(MC.MAJOR_STAT_AREA_CODE IN ('03', '04', '05','06','07','08','09') OR (MC.MAJOR_STAT_AREA_CODE = '01' AND MC.MINOR_STAT_AREA_CODE = '20')) AND
	...
	CASE WHEN MC.DATABASE_NAME = 'GFCatch' THEN E.Time
		ELSE (CASE WHEN MC.BEST_DATE < '2018-10-08' AND
				(CONVERT(VARCHAR(8),CAST(MC.FE_END_DATE AS TIME)) = '23:59:00' OR
				CONVERT(VARCHAR(8),CAST(MC.FE_START_DATE AS TIME)) = '00:01:00')
			THEN 0
			ELSE CONVERT(DECIMAL,DATEDIFF(N,MC.FE_START_DATE, MC.FE_END_DATE))/60
	...
	--Use only successful tows as defined in each database
	...
	ORDER BY YEAR(BEST_DATE), MONTH(BEST_DATE)
