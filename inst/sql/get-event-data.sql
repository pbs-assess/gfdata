SELECT
    ...
    CASE WHEN FE_MINOR_LEVEL_ID IS NULL AND FE_PARENT_EVENT_ID IS NOT NULL COUNT(FE.FISHING_EVENT_ID) AS SKATE_COUNT,
    CASE WHEN FE_MINOR_LEVEL_ID IS NOT NULL AND FE_PARENT_EVENT_ID IS NOT NULL COUNT(FE.FISHING_EVENT_ID) AS HOOK_COUNT,
    LGLSP_HOOK_COUNT,
    LGLSP_SKATE_COUNT,
