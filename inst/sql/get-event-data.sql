SELECT
    ...
    GROUPING_DESC AS GROUPING_DESC_ORIGINAL,
    ...
    FROM FISHING_EVENT FE
      ...
      LEFT JOIN SURVEY S ON S.SURVEY_ID = TRS.SURVEY_ID AND S.SURVEY_SERIES_ID = G.SURVEY_SERIES_ID
      LEFT JOIN SURVEY_GROUPING SG ON SG.SURVEY_ID = S.SURVEY_ID AND SG.GROUPING_CODE = FE.GROUPING_CODE
