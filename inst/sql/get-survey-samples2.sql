SELECT
  ...
  SM.GROUPING_CODE AS GROUPING_CODE_ORIGINAL1,
  G.GROUPING_DESC AS GROUPING_DESC_ORIGINAL1,
  SSG.GROUPING_CODE AS GROUPING_CODE_EXPECTED1, -- expected for updated survey definition
  FEG.GROUPING_CODE AS GROUPING_CODE1, -- for updated survey definitions
  S.ORIGINAL_IND
  ...
  LEFT JOIN GFBioSQL.dbo.SURVEY_GROUPING SG ON SG.SURVEY_ID = TS.SURVEY_ID AND SG.GROUPING_CODE = FE.GROUPING_CODE
  LEFT JOIN (
  ...
  ) SSG ON SSG.GROUPING_CODE = FE.GROUPING_CODE AND SSG.SURVEY_SERIES_ID = G.SURVEY_SERIES_ID
  LEFT JOIN FISHING_EVENT_GROUPING FEG ON SG.GROUPING_CODE = FEG.GROUPING_CODE AND SM.FISHING_EVENT_ID = FEG.FISHING_EVENT_ID
