...
FROM GFBioSQL.dbo.B21_Samples SM
  ...
  LEFT JOIN GFBioSQL.dbo.SURVEY S ON S.SURVEY_ID = TS.SURVEY_ID
  LEFT JOIN GFBioSQL.dbo.SURVEY_GROUPING SG ON SG.GROUPING_CODE = FE.GROUPING_CODE AND S.SURVEY_ID = SG.SURVEY_ID
